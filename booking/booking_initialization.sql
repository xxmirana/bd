...
CREATE TABLE Hotel (
	ID_hotel SERIAL PRIMARY KEY,  -- автоматическая генерация идентификаторов с применением SERIAL
...
CREATE TABLE Room (
	ID_room SERIAL PRIMARY KEY, 	-- автоматическая генерация идентификаторов с применением SERIAL
	ID_hotel INT,
...
CREATE TABLE Customer (
	ID_customer SERIAL PRIMARY KEY,  -- автоматическая генерация идентификаторов с применением SERIAL
	name VARCHAR(255) NOT NULL,
...
CREATE TABLE Booking (
	ID_booking SERIAL PRIMARY KEY,   -- автоматическая генерация идентификаторов с применением SERIAL
	ID_room INT,
	ID_customer INT,
